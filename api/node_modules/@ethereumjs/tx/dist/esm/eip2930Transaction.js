...
import { MAX_INTEGER, bigIntToHex, bigIntToUnpaddedBytes, bytesToBigInt, bytesToHex, concatBytes, ecrecover, equalsBytes, hexToBytes, toBytes, validateNoLeadingZeroes, } from '@ethereumjs/util';
import { keccak256 } from 'ethereum-cryptography/keccak.js';
import { BaseTransaction } from './baseTransaction.js';
import { TransactionType } from './types.js';
import { AccessLists } from './util.js';
const TRANSACTION_TYPE_BYTES = hexToBytes('0x' + TransactionType.AccessListEIP2930.toString(16).padStart(2, '0'));
/**
