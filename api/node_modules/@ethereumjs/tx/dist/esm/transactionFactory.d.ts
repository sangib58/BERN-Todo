...
export declare class TransactionFactory {
     ...
     * @param txOptions - The transaction options
     */
    static fromBlockBodyData(data: Uint8Array | Uint8Array[], txOptions?: TxOptions): FeeMarketEIP1559Transaction | AccessListEIP2930Transaction | BlobEIP4844Transaction | LegacyTransaction;
    /**
     ...
     */
    static fromJsonRpcProvider(provider: string | EthersProvider, txHash: string, txOptions?: TxOptions): Promise<FeeMarketEIP1559Transaction | AccessListEIP2930Transaction | BlobEIP4844Transaction | LegacyTransaction>;
    /**
