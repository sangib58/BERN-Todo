...
const TRANSACTION_TYPE_BYTES = (0, util_1.hexToBytes)('0x' + types_js_1.TransactionType.AccessListEIP2930.toString(16).padStart(2, '0'));
/**
...
class AccessListEIP2930Transaction extends baseTransaction_js_1.BaseTransaction {
    ...
    getDataFee() {
        ...
        cost += BigInt(util_js_1.AccessLists.getDataFeeEIP2930(this.accessList, this.common));
