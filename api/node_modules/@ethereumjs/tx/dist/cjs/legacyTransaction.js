...
class LegacyTransaction extends baseTransaction_js_1.BaseTransaction {
    ...
    getSenderPublicKey() {
        ...
        this._validateHighS();
        try {
            return (0, util_1.ecrecover)(msgHash, v, (0, util_1.bigIntToUnpaddedBytes)(r), (0, util_1.bigIntToUnpaddedBytes)(s), this.supports(types_js_1.Capability.EIP155ReplayProtection) ? this.common.chainId() : undefined);
        }
        catch (e) {
