...
const TRANSACTION_TYPE_BYTES = (0, util_1.hexToBytes)('0x' + types_js_1.TransactionType.BlobEIP4844.toString(16).padStart(2, '0'));
const validateBlobTransactionNetworkWrapper = (versionedHashes, blobs, commitments, kzgProofs, version) => {
    ...
    for (let x = 0; x < versionedHashes.length; x++) {
        ...
        if (!(0, util_1.equalsBytes)(computedVersionedHash, versionedHashes[x])) {
...
class BlobEIP4844Transaction extends baseTransaction_js_1.BaseTransaction {
    ...
    constructor(txData, opts = {}) {
        ...
        this.versionedHashes = (txData.versionedHashes ?? []).map((vh) => (0, util_1.toBytes)(vh));
        ...
        if (this.versionedHashes.length > constants_js_1.LIMIT_BLOBS_PER_TX) {
    ...
    static fromTxData(txData, opts) {
        if (txData.blobsData !== undefined) {
            ...
            txData.versionedHashes = (0, util_1.commitmentsToVersionedHashes)(txData.kzgCommitments);
    ...
    static fromSerializedTx(serialized, opts = {}) {
        if ((0, util_1.equalsBytes)(serialized.subarray(0, 1), TRANSACTION_TYPE_BYTES) === false) {
    ...
    serialize() {
        const base = this.raw();
        return (0, util_1.concatBytes)(TRANSACTION_TYPE_BYTES, rlp_1.RLP.encode(base));
    }
    /**
    ...
    serializeNetworkWrapper() {
        ...
        return (0, util_1.concatBytes)(TRANSACTION_TYPE_BYTES, rlp_1.RLP.encode([tx_payload, this.blobs, this.kzgCommitments, this.kzgProofs]));
    }
    /**
    ...
    getMessageToSign() {
        ...
        const message = (0, util_1.concatBytes)(TRANSACTION_TYPE_BYTES, rlp_1.RLP.encode(base));
        return message;
    }
    /**
    ...
    getHashedMessageToSign() {
        return (0, keccak_js_1.keccak256)(this.getMessageToSign());
    }
    /**
    ...
    getSenderPublicKey() {
        ...
        try {
            ...
            (0, util_1.bigIntToUnpaddedBytes)(r), (0, util_1.bigIntToUnpaddedBytes)(s));
        }
        catch (e) {
    ...
    toJSON() {
        ...
        return {
            ...
            versionedHashes: this.versionedHashes.map((hash) => (0, util_1.bytesToHex)(hash)),
        };
    }
